...
export default function HomeView({ config, onNavigate }: HomeViewProps) {
  ...
  return (
    <div id="home-view" className="space-y-0 pb-0">
      ...
      <section id="hero-section" className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden w-full bg-app-bg-60">
      ...
      <section id="manifesto-intro" className="w-full bg-app-bg-60 py-16 border-t border-app-accent-charcoal/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <motion.div 
            ...
            className="bg-app-bg-60 border border-app-accent-charcoal/15 p-8 rounded-lg flex flex-col justify-between space-y-8 shadow-[0_12px_24px_-8px_rgba(69,67,64,0.1)] hover:shadow-[0_20px_40px_-10px_rgba(117,109,82,0.18)] transition-all duration-400"
          >
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-md bg-app-accent-olive/10 text-app-accent-olive flex items-center justify-center transition-colors hover:bg-app-accent-olive/20">
                <ShieldAlert size={24} />
              </div>
              <h3 className="font-sans text-xl font-bold text-app-accent-charcoal tracking-tight">Abbatto la Barriera Tecnica</h3>
          ...
          >
            <div className="space-y-4">
              ...
              <h3 className="font-sans text-xl font-bold text-app-accent-charcoal tracking-tight">Umanesimo Digitale Reale</h3>
              <p className="font-sans text-sm text-app-text-30/95 leading-relaxed">
          ...
          <motion.div 
            ...
            whileHover={{ y: -8, borderColor: "rgba(117,109,82,0.4)" }}
            className="bg-app-bg-60 border border-app-accent-charcoal/15 p-8 rounded-lg flex flex-col justify-between space-y-8 shadow-[0_12px_24px_-8px_rgba(69,67,64,0.1)] hover:shadow-[0_20px_40px_-10px_rgba(117,109,82,0.18)] transition-all duration-400 md:col-span-2 lg:col-span-1"
          >
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-md bg-app-accent-olive/10 text-app-accent-olive flex items-center justify-center transition-colors hover:bg-app-accent-olive/20">
                <Workflow size={24} />
              </div>
              <h3 className="font-sans text-xl font-bold text-app-accent-charcoal tracking-tight">Rigore Strutturale Visivo</h3>
              <p className="font-sans text-sm text-app-text-30/95 leading-relaxed">
      ...
      <section id="social-preview-section" className="bg-app-bg-60 border-y border-app-accent-charcoal/10 py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h2 className="font-sans text-3xl sm:text-4xl font-bold text-app-accent-charcoal leading-tight">
                {socialData.title}
              </h2>
              ...
              <div className="pt-4">
                <button
                  ...
                  className="font-sans font-semibold text-sm uppercase tracking-wider bg-app-accent-olive text-app-bg-60 px-6 py-3.5 rounded-md shadow-[0_10px_20px_-10px_rgba(117,109,82,0.3)] hover:bg-app-accent-charcoal transition-all flex items-center gap-2 cursor-pointer"
                >
                  Vedi il Sistema
                  <ArrowRight size={16} />
                </button>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-6">
              {socialData.pillars.map((pillar, idx) => (
                <motion.div
                  ...
                  className="bg-app-bg-60 border border-app-accent-charcoal/20 p-6 rounded-md space-y-4 shadow-[0_8px_16px_-4px_rgba(69,67,64,0.06)] hover:shadow-[0_16px_32px_-8px_rgba(117,109,82,0.15)] transition-all duration-350 cursor-default"
                >
                  <span className="font-mono text-2xl font-bold text-app-accent-khaki/60 block">
                    {pillar.index}
                  </span>
                  <h4 className="font-sans font-bold text-app-accent-charcoal text-base">
                    {pillar.title}
                  </h4>
      ...
      <section id="ai-case-studies" className="bg-app-text-30 text-app-bg-60 py-20 border-y border-app-accent-charcoal">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
              whileHover={{ y: -6 }}
              className="bg-app-text-30 border border-app-accent-charcoal hover:border-app-accent-khaki-2/40 p-8 rounded-lg space-y-4 transition-all duration-300 shadow-lg"
            >
              <div className="w-10 h-10 rounded-full bg-app-accent-khaki-2/10 text-app-accent-khaki-2 flex items-center justify-center">
                <Smartphone size={20} />
              </div>
              <h3 className="font-sans font-bold text-lg text-app-bg-60">Lead qualificati in automatico</h3>
              ...
              <div className="pt-2">
                <span className="font-mono text-[10px] text-app-accent-khaki-2 bg-app-accent-khaki-2/10 px-2.5 py-1 rounded">
            ...
            >
              ...
              <h3 className="font-sans font-bold text-lg text-app-bg-60">Piano Editoriale in 15 minuti</h3>
              <p className="font-sans text-xs text-app-bg-60/80 leading-relaxed">
            ...
            >
              ...
              <h3 className="font-sans font-bold text-lg text-app-bg-60">Pre-profilazione e Appuntamenti</h3>
              <p className="font-sans text-xs text-app-bg-60/80 leading-relaxed">
      ...
      <section id="services-preview" className="w-full bg-app-bg-60 py-20 border-t border-app-accent-charcoal/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            initial={{ opacity: 0, y: 25 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <span className="font-mono text-xs font-semibold text-app-accent-olive tracking-widest uppercase mb-1 block">
              I Miei Pilastri Tecnologici
            </span>
            <h2 className="font-sans text-3xl sm:text-4xl font-bold text-app-accent-charcoal">
              Sviluppo Web Strategico Integrato
            </h2>
            <p className="font-sans text-sm text-app-text-30 leading-relaxed">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
            whileHover={{ y: -8, borderColor: "rgba(117,109,82,0.4)" }}
            className="bg-app-bg-60 border border-app-accent-charcoal/15 rounded-lg p-8 space-y-6 flex flex-col justify-between shadow-[0_15px_30px_-5px_rgba(69,67,64,0.08)] hover:shadow-[0_24px_48px_-8px_rgba(117,109,82,0.18)] transition-all duration-400 relative overflow-hidden group"
          >
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-mono text-[10px] tracking-wider uppercase bg-app-accent-olive/10 text-app-accent-olive px-2.5 py-1 rounded">
                  {serviziData.option_wordpress.tag}
                </span>
                <Laptop className="text-app-accent-khaki" size={24} />
              </div>
              <h3 className="font-sans text-2xl font-bold text-app-accent-charcoal">
                {serviziData.option_wordpress.title}
              </h3>
              <p className="font-sans text-sm font-semibold text-app-accent-olive">
              ...
              <ul className="space-y-2 pt-2">
                {serviziData.option_wordpress.features.slice(0, 3).map((feat, idx) => (
                  <li key={idx} className="font-sans text-xs text-app-text-30 flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-app-accent-olive" />
                    {feat}
                  </li>
                ))}
              </ul>
            ...
            <div className="pt-6">
              <button
                ...
                className="font-sans font-bold text-xs text-app-accent-olive hover:text-app-accent-charcoal uppercase tracking-wider flex items-center gap-2.5 cursor-pointer group-hover:translate-x-1 transition-transform"
              >
          ...
          >
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-mono text-[10px] tracking-wider uppercase bg-app-accent-khaki/10 text-app-accent-olive px-2.5 py-1 rounded">
                  {serviziData.option_custom_code.tag}
                </span>
                <CodeXml className="text-app-accent-khaki" size={24} />
              </div>
              <h3 className="font-sans text-2xl font-bold text-app-accent-charcoal">
              ...
              <ul className="space-y-2 pt-2">
                {serviziData.option_custom_code.features.slice(0, 3).map((feat, idx) => (
                  <li key={idx} className="font-sans text-xs text-app-text-30 flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-app-accent-khaki" />
                    {feat}
                  </li>
                ))}
              </ul>
      ...
      {/* Dynamic CTA Banner */}
      <section id="banner-cta" className="w-full bg-app-bg-60 py-16 border-t border-app-accent-charcoal/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="bg-app-accent-olive text-app-bg-60 rounded-lg p-8 md:p-12 text-center space-y-6 shadow-[0_10px_30px_rgba(117,109,82,0.15)] relative overflow-hidden">
            <div className="absolute inset-0 bg-radial from-transparent to-app-accent-charcoal/20 pointer-events-none" />
            <div className="relative z-10 max-w-2xl mx-auto space-y-4">
              ...
              <p className="font-sans text-sm sm:text-base text-app-bg-60/90 leading-relaxed">
              ...
              <div className="pt-4 flex justify-center">
                <button
                  id="banner-cta-btn"
                  onClick={() => onNavigate("/contatti")}
                  className="font-sans font-semibold text-sm uppercase tracking-wider bg-app-bg-60 text-app-accent-olive hover:bg-app-bg-60/90 px-8 py-4 rounded-md shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-all transform hover:-translate-y-0.5 cursor-pointer"
                >
