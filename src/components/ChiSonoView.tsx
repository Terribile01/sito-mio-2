...
export default function ChiSonoView({ config, onNavigate }: ChiSonoProps) {
  ...
  return (
    <div id="chisono-view" className="space-y-0 pb-0">
      ...
      {/* Hero Header */}
      <section id="chisono-hero" className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden w-full bg-[#E2DDD3]">
      ...
      <section id="chisono-story" className="w-full bg-[#E2DDD3] py-16 border-t border-[#454340]/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 space-y-6 text-[#2D2B28]"
          >
      ...
      <section id="chisono-target" className="w-full bg-[#E2DDD3] border-t border-[#454340]/10 py-16">
